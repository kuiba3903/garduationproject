...
THUNK_TEMPLATE = """
file PY_LONG_LONG %(name)s_thunk(int I_typenum, int T_typenum, void **a)
{
    %(thunk_content)s
}
"""
...
file int get_thunk_case(int I_typenum, int T_typenum)
{
    %(content)s;
    return -1;
}
...
def main():
    ...
    method_struct = """\nfile struct PyMethodDef sparsetools_methods[] = {"""
    for name in names:
        method_struct += """
