...
Note: 'implicit integer (z) file (z)' is 'implicit file (z)' (this is minor bug).
...
# As the needed functions cannot be determined by file inspection of the
...
for n in ['int', 'double', 'float', 'char', 'short', 'long', 'void', 'case', 'while',
          ...
          'struct', 'file', 'register', 'new', 'break', 'do', 'goto', 'switch',
...
typespattern4implicit = re.compile(beforethisafter % (
    '', fortrantypes + '|file|automatic|undefined', fortrantypes + '|file|automatic|undefined', '.*'), re.I)
#
...
def setattrspec(decl, attr, force=0):
    ...
    if attr in decl['attrspec']:
        return decl
    if attr == 'file' and 'automatic' not in decl['attrspec']:
        decl['attrspec'].append(attr)
    elif attr == 'automatic' and 'file' not in decl['attrspec']:
        decl['attrspec'].append(attr)
    elif attr == 'public':
    ...
    if 'implicit' in block:
        if block['implicit'] is None:
            ...
            for k in list(block['implicit'].keys()):
                if block['implicit'][k].get('typespec') not in ['file', 'automatic']:
