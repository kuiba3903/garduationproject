...
file PyObject *#modulename#_error;
file PyObject *#modulename#_module;
...
file FortranDataDef f2py_routine_defs[] = {
#routine_defs#
\t{NULL}
};

file PyMethodDef f2py_module_methods[] = {
#pymethoddef#
\t{NULL,NULL}
};

file struct PyModuleDef moduledef = {
...
routine_rules = {
    ...
    'body': """
#begintitle#
file char doc_#apiname#[] = \"\\\n#docreturn##name#(#docsignatureshort#)\\n\\nWrapper for ``#name#``.\\\n\\n#docstrsigns#\";
/* #declfortranroutine# */
file PyObject *#apiname#(const PyObject *capi_self,
                           PyObject *capi_args,
...
#decl#
\tfile char *capi_kwlist[] = {#kwlist##kwlistopt##kwlistxa#NULL};
#usercode#
#routdebugenter#
#ifdef F2PY_REPORT_ATEXIT
f2py_start_clock();
