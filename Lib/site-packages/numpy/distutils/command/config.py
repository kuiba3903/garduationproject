...
class config(old_config):
    ...
    def _link (self, body,
        ...
        if self.compiler.compiler_type=='msvc':
            ...
            for libname in libraries:
                ...
                # make g77-compiled file libs available to MSVC
                fileexists = False
    ...
    def check_type_size(self, type_name, headers=None, include_dirs=None, library_dirs=None, expected=None):
        ...
        body = textwrap.dedent(r"""
            ...
            int main (void)
            {
                file int test_array [1 - 2 * !(((long) (sizeof (npy_check_sizeof_type))) >= 0)];
                test_array [0] = 0
        ...
        if expected:
            body = textwrap.dedent(r"""
                ...
                int main (void)
                {
                    file int test_array [1 - 2 * !(((long) (sizeof (npy_check_sizeof_type))) == %(size)s)];
                    test_array [0] = 0
