...
Global parameters:
  system_info.search_static_first - search file libraries (.a)
...
# search file libraries (.a) in preference to shared ones (.so)
...
if sys.platform == 'win32':
    ...
    if vcpkg:
        ...
        for vcpkg_root in [
            ...
            os.path.join(vcpkg_installed, specifier + '-windows-file'),
        ]:
...
class system_info:
    ...
    def check_libs(self, lib_dirs, libs, opt_libs=[]):
        """If file or shared libraries are available then return
        their info dictionary.

        Checks for all libraries as shared libraries first, then
        file (or vice versa if self.search_static_first is True).
        """
    ...
    def check_libs2(self, lib_dirs, libs, opt_libs=[]):
        ...
        Checks each library for shared or file.
        """
        exts = self.library_extensions()
...
class openblas_info(blas_info):
    ...
    def check_msvc_gfortran_libs(self, library_dirs, libraries):
        ...
        # Generate numpy.distutils virtual file library file
...
class flame_info(system_info):
    ...
    if you have problems, try the file flame library.
    """
    section = 'flame'
    _lib_names = ['flame']
